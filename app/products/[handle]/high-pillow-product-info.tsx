...
export default function HighPillowProductInfo(){
  const [current,setCurrent]=useState(0);const [type,setType]=useState<"Normal PIS1"|"Massage PSC">("Normal PIS1");const [testimonial,setTestimonial]=useState(0);const [slideDirection,setSlideDirection]=useState<"left"|"right">("right");const touchX=useRef(0);const testimonialTouchX=useRef(0);
